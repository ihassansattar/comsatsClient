                    ...
                    <div class="card-body">
                        <form method="POST">
                            ...
                            <div class="form-row">
                                ...
                                <div class="value">
                                    <input class="input--style-6" type="number" name="full_name" placeholder="For the Program Under Evaluation" value={totalDedicatedRooms} onChange={(e) => settotalDedicatedRooms(e.target.value)} />
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="name">Total Number of Shared Lecture Rooms</div>
                                <div class="value">
                                    <input class="input--style-6" type="number" name="full_name" placeholder="For the Program Under Evaluation" value={totalSharedRooms} onChange={(e) => settotalSharedRooms(e.target.value)} />
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="name">Average size of each lecture room</div>
                                <div class="value">
                                    <input class="input--style-6" type="number" name="full_name" placeholder="In Square Feet" value={roomsize} onChange={(e) => setroomsize(e.target.value)} />
                                </div>
                            </div>
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                ...
                                <div class="value">
                                    <input class="input--style-6" type="number" name="full_name" placeholder="For the Program Under Evaluation" value={totalComputerLabs} onChange={(e) => settotalComputerLabs(e.target.value)} />
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="name">Average Number Of Computers per Lab</div>
                                <div class="value">
                                    <input class="input--style-6" type="number" name="full_name" placeholder="For the Program Under Evaluation" value={averageComputerLabs} onChange={(e) => setaverageComputerLabs(e.target.value)} />
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="name">Average Lifetime of PC in computer labs</div>
                                <div class="value">
                                    <input class="input--style-6" type="number" name="full_name" placeholder="No of Years" value={pcLifeTime} onChange={(e) => setpcLifeTime(e.target.value)} />
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="value">
                                    <input class="input--style-6" type="number" name="full_name" placeholder="please write clear answer" value={totalLabHours} onChange={(e) => settotalLabHours(e.target.value)} />
                                </div>
                            </div>
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                ...
                                <div class="value">
                                    <input class="input--style-6" type="number" name="full_name" placeholder="please write clear answer" value={studentToComputerRatio1} onChange={(e) => setstudentToComputerRatio1(e.target.value)} />
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="name">Students to Computer Ratio</div>
                                <div class="value">
                                    <input class="input--style-6" type="number" name="full_name" placeholder="please write clear answer" value={studentToComputerRatio2} onChange={(e) => setstudentToComputerRatio2(e.target.value)} />
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="name">Students to Computer Ratio</div>
                                <div class="value">
                                    <input class="input--style-6" type="number" name="full_name" placeholder="please write clear answer" value={studentToComputerRatio3} onChange={(e) => setstudentToComputerRatio3(e.target.value)} />
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="value">
                                    <input class="input--style-6" type="number" name="full_name" placeholder="please write clear answer" value={totalLibraryBooks} onChange={(e) => settotalLibraryBooks(e.target.value)} />
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="name">Total Number of Unique titles in Library</div>
                                <div class="value">
                                    <input class="input--style-6" type="number" name="full_name" placeholder="please write clear answer" value={uniqueTitle} onChange={(e) => setuniqueTitle(e.target.value)} />
                                </div>
                            </div>
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                ...
                                <div class="value">
                                    <input class="input--style-6" type="number" name="full_name" placeholder="please write clear answer" value={printedMagzines1} onChange={(e) => setprintedMagzines1(e.target.value)} />
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="name">Number of printed technical magazines</div>
                                <div class="value">
                                    <input class="input--style-6" type="number" name="full_name" placeholder="please write clear answer" value={printedMagzines2} onChange={(e) => setprintedMagzines2(e.target.value)} />
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="name">Number of printed technical magazines</div>
                                <div class="value">
                                    <input class="input--style-6" type="number" name="full_name" placeholder="please write clear answer" value={printedMagzines3} onChange={(e) => setprintedMagzines3(e.target.value)} />
                                </div>
                            </div>
                        </form>
                        </div>
