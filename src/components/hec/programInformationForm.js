                    ...
                    <div class="card-body">
                        <form method="POST">
                            ...
                            <div class="form-row">
                                ...
                                <div class="value">
                                    <div class="input-group">
                                        <textarea class="textarea--style-6" name="message" placeholder="Providing admission eligibility policy rearding program under evalution" value={admissionPolicy} disabled onChange={(e) => setadmissionPolicy(e.target.value)}></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                ...
                                <div class="value">
                                    <input class="input--style-6" type="number" name="full_name" value={totalStudents1} disabled onChange={(e) => settotalStudents1(e.target.value)} />
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="name">Total Number of sections</div>
                                <div class="value">
                                    <input class="input--style-6" type="number" name="full_name" value={totalSections1} disabled onChange={(e) => settotalSections1(e.target.value)} />
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="name">Average Number of students per section</div>
                                <div class="value">
                                    <input class="input--style-6" type="number" name="full_name" value={averageStudents1} disabled onChange={(e) => setaverageStudents1(e.target.value)} />
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="name">Total Number of students</div>
                                <div class="value">
                                    <input class="input--style-6" type="number" name="full_name" value={totalStudents2} disabled onChange={(e) => settotalStudents2(e.target.value)} />
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="name">Total Number of sections</div>
                                <div class="value">
                                    <input class="input--style-6" type="number" name="full_name" value={totalSections2} disabled onChange={(e) => settotalSections2(e.target.value)} />
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="name">Average Number of students per section</div>
                                <div class="value">
                                    <input class="input--style-6" type="number" name="full_name" value={averageStudents2} disabled onChange={(e) => setaverageStudents2(e.target.value)} />
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="name">Total Number of students</div>
                                <div class="value">
                                    <input class="input--style-6" type="number" name="full_name" value={totalStudents3} disabled onChange={(e) => settotalStudents3(e.target.value)} />
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="name">Total Number of sections</div>
                                <div class="value">
                                    <input class="input--style-6" type="number" name="full_name" value={totalSections3} disabled onChange={(e) => settotalSections3(e.target.value)} />
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="name">Average Number of students per section</div>
                                <div class="value">
                                    <input class="input--style-6" type="number" name="full_name" value={averageStudents3} disabled onChange={(e) => setaverageStudents3(e.target.value)} />
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="name">Total Number of students</div>
                                <div class="value">
                                    <input class="input--style-6" type="number" name="full_name" value={totalStudents4} disabled onChange={(e) => settotalStudents4(e.target.value)} />
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="name">Total Number of sections</div>
                                <div class="value">
                                    <input class="input--style-6" type="number" name="full_name" value={totalSections4} disabled onChange={(e) => settotalSections4(e.target.value)} />
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="name">Average Number of students per section</div>
                                <div class="value">
                                    <input class="input--style-6" type="number" name="full_name" value={averageStudents4} disabled onChange={(e) => setaverageStudents4(e.target.value)} />
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="name">Total Number of students</div>
                                <div class="value">
                                    <input class="input--style-6" type="number" name="full_name" value={totalStudents5} disabled onChange={(e) => settotalStudents5(e.target.value)} />
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="name">Total Number of sections</div>
                                <div class="value">
                                    <input class="input--style-6" type="number" name="full_name" value={totalSections5} disabled onChange={(e) => settotalSections5(e.target.value)} />
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="name">Average Number of students per section</div>
                                <div class="value">
                                    <input class="input--style-6" type="number" name="full_name" value={averageStudents5} disabled onChange={(e) => setaverageStudents5(e.target.value)} />
                                </div>
                            </div>
                        </form>
                        </div>
