...
export default function AdminProfile(props) {
      ...
      <ListItem button selected={selectedIndex === 13} onClick={event => handleListItemClick(event, 13, 'labComponents')}>
        ...
        <ListItemText style={{ color: "white" }} primary="Lab Components" />
            ...
            <ListItem button selected={selectedIndex === 1} onClick={event => handleListItemClick(event, 1, 'infrastructureInformation')}>
              <ListItemIcon className={classes.color} style={{ color: "white" }}><VisibilityIcon/> </ListItemIcon>
              <ListItemText style={{ color: "white" }} primary="INFRASTRUCTUR INFORMATION" />
            </ListItem>

            <ListItem button selected={selectedIndex === 2} onClick={event => handleListItemClick(event, 2, 'programInformation')}>
            <ListItemIcon className={classes.color} style={{ color: "white" }}><VisibilityIcon/> </ListItemIcon>
              <ListItemText style={{ color: "white" }} primary="PROGRAM INFORMATION" />
            </ListItem>
            <Divider />
            ...
            <ListItemIcon className={classes.color} style={{ color: "white" }}><VisibilityIcon/> </ListItemIcon>
              <ListItemText style={{ color: "white" }} primary="FINANCIAL INFORMATION" />
            </ListItem>

            <ListItem button selected={selectedIndex === 4} onClick={event => handleListItemClick(event, 4, 'generalInformation')}>
            <ListItemIcon className={classes.color} style={{ color: "white" }}><VisibilityIcon/> </ListItemIcon>
              <ListItemText style={{ color: "white" }} primary="GENERAL INFORMATION" />
            </ListItem>
            <Divider />
        ...
        <ListItem button selected={selectedIndex === 5} onClick={event => handleListItemClick(event, 5, 'UpdateProfile')}>
          ...
          <ListItemText style={{ color: "white" }} primary="Update Profile" />
        </ListItem>
  ...
  const Navigation = () => {
    switch (change) {
      ...
      default: return <div><h1>Welcome To Comsats Accriditation Portal</h1><h5>Login for Heigher Education Admin</h5></div>
    }
  }
